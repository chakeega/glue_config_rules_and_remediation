...
DEFAULT_RESOURCE_TYPE = 'AWS::Glue::DataCatalogEncryptionSettings'
...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    ...
    catalog_encryption = response['DataCatalogEncryptionSettings']['EncryptionAtRest']['CatalogEncryptionMode']
    password_encryption = response['DataCatalogEncryptionSettings']['ConnectionPasswordEncryption']['ReturnConnectionPasswordEncrypted']

    #if encryption is not enabled for both then put into non-compliant evaluation
    if catalog_encryption == 'DISABLED' or password_encryption == False:
        evaluations.append(build_evaluation('Data Catalog Settings',
                                            'NON_COMPLIANT',
                                            event,
                                            annotation="The Glue Data Catalog is not encrypted"))
